...
class SermonScreen extends Component {
  ...
  async componentDidMount() {
    ...
    this.data = []
    await fetch('https://nepho.id/pondokpujian/api/sermon.php?bundle_id=' + this.bundle_id,
      {
        method: 'POST',
      })
  ...
  async Play() {
    ...
    for (let i = 0; i < this.data.length; i++) {
      ...
      this.episode.push({
        "id": i,
        "title": this.data[i].sermon_title,
        "url": "https://nepho.id/pondokpujian/sermon/" + this.data[i].sermon_id + ".mp3",
        "artwork": 'https://nepho.id/pondokpujian/img/' + this.thumbnail
      })
  ...
  async generateAll(id) {
    ...
    this.song_title = this.data[Number(id)].sermon_title
            ...
            title={(props) => (
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <Avatar
                  ...
                  source={{ uri: 'https://nepho.id/pondokpujian/img/' + this.thumbnail }}
                />
                <Text {...props}>
                  {this.song_title}
                </Text>
              ...
              <React.Fragment>
                ...
                {!(this.partitur == undefined || this.partitur == null || this.partitur == "" || this.partitur == 0) && (
                  <TouchableOpacity onPress={() => {
                    ...
                    this.setState({ partitur: !this.state.partitur })
                  ...
                  <View>
                    ...
                    <View style={{ flex: 5, justifyContent: "center", alignItems: "center", flexDirection: "row", marginTop: 40 }}>
                      ...
                      <TouchableOpacity style={{ flex: 1, alignItems: "center" }} onPress={async () => {
                        ...
                        this.song_title = this.data[this.position].sermon_title
